...
const navItemTemplates = [
    ...
    {
        baseHref: "/dashboard/tutor/students",
        label: "My Students",
    ...
    {
        baseHref: "/dashboard/student/tutors",
        label: "My Tutors",
        icon: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$users$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Users$3e$__["Users"],
        roles: [
            "STUDENT"
...
function Sidebar({ currentRole }) {
    ...
    const generateNavItems = (templates)=>{
        return templates.filter((item)=>{
            ...
            if (item.baseHref.startsWith('/dashboard/') && !item.baseHref.startsWith('/dashboard/student') && !item.baseHref.startsWith('/dashboard/tutor') && item.baseHref !== '/dashboard') {
    ...
    const asideClasses = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("hidden md:flex w-60 flex-col border-r", "bg-sidebar text-sidebar-foreground border-sidebar-border" // Use sidebar-specific colors
    );
    const navLinkClasses = (href)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("flex items-center gap-3 rounded-lg px-3 py-2 transition-colors", "text-sidebar-muted-foreground hover:text-sidebar-accent-foreground hover:bg-sidebar-accent/10", {
...
_s(DashboardWrapper, "Y7Wg4DusSA4xEW1elo/bdMqLyr0=", false, function() {
    return [
...
//# sourceMappingURL=_6ea52528._.js.map