            ...
            const fetchData = {
                "StudentDashboardPage.useEffect.fetchData": async ()=>{
                    ...
                    try {
                        ...
                        sessions?.forEach({
                            "StudentDashboardPage.useEffect.fetchData": (session)=>{
                        ...
                        const processedWeeklyData = Object.entries(weeklyHoursMap).map({
                            "StudentDashboardPage.useEffect.fetchData.processedWeeklyData": ([day, hours])=>({
                                    day,
                                    hours: parseFloat(hours.toFixed(1))
                                })
                        }["StudentDashboardPage.useEffect.fetchData.processedWeeklyData"]);
                        ...
                        const subjectScores = {};
                        exercises?.forEach({
                            "StudentDashboardPage.useEffect.fetchData": (ex)=>{
                        ...
                        const calculatedSubjectScoresData = Object.entries(subjectScores).map({
                            "StudentDashboardPage.useEffect.fetchData.calculatedSubjectScoresData": ([subject, data])=>({
                                    subject,
                                    score: Math.round(data.total / data.count)
                                })
                        }["StudentDashboardPage.useEffect.fetchData.calculatedSubjectScoresData"]);
...
_s(StudentDashboardPage, "G394uWet9AwtVGxzGmrG20m5cMc=", false, function() {
    return [
