...
function createClient() {
    ...
    const supabaseUrl = ("TURBOPACK compile-time value", "https://zklfxzlknnubnwzzkuaw.supabase.co");
    const supabaseAnonKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InprbGZ4emxrbm51Ym53enprdWF3Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDQ0ODk3MzQsImV4cCI6MjA2MDA2NTczNH0.jpAk-fd3kRFENDXn6LdMife5_QEA9PvAnw158tnm9iw");
...
function AuthProvider({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
            ...
            try {
                ...
                if (sessionError) {
                    ...
                    if (currentSession?.user) {
                        ...
                        const { data: profileData, error: profileError } = await supabase.from('profiles').select('*').eq('id', currentSession.user.id).maybeSingle(); // Use maybeSingle() instead of single()
                        if (profileError) {
                            console.error("ERRORRRR");
                            setProfile(null);
        ...
        const { data: authListener } = supabase.auth.onAuthStateChange(async (_event, newSession)=>{
            ...
            if (newSession?.user) {
                ...
                try {
                    ...
                    const { data: profileData, error: profileError } = await supabase.from('profiles').select('*').eq('id', newSession.user.id).maybeSingle(); // Use maybeSingle() here too
                    if (profileError) {
        ...
        supabase
    ]); // Dependency array includes supabase client
    const signOut = async ()=>{
        setLoading(true);
...
;
;
function DashboardLayoutInternal({ children }) {
    ...
    const { profile, signOut, loading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$AuthContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuth"])();
    if (loading) {
...
function DashboardLayout({ children }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$AuthContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AuthProvider"], {
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(DashboardLayoutInternal, {
            children: children
        }, void 0, false, {
            fileName: "[project]/src/components/layout/dashboard-layout.tsx",
            lineNumber: 133,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ae3661e8._.js.map