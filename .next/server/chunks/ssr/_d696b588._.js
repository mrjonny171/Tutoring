...
function Sidebar({ currentRole }) {
    ...
    const asideClasses = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cn"])("hidden md:flex w-60 flex-col border-r", "bg-sidebar text-sidebar-foreground border-sidebar-border" // Use sidebar-specific colors
    );
    const navLinkClasses = (href)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cn"])("flex items-center gap-3 rounded-lg px-3 py-2 transition-colors", "text-sidebar-muted-foreground hover:text-sidebar-accent-foreground hover:bg-sidebar-accent/10", {
...
//# sourceMappingURL=_d696b588._.js.map