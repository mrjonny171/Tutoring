...
function Sidebar({ currentRole }) {
    ...
    const getFilteredNavItems = (items)=>{
        return items.filter((item)=>{
            ...
            if (roleSpecificPath && item.roles.includes(currentRole)) return true; // Check role here too
            // Shared links (check if the *base* path matches the start of current pathname)
            // And ensure it's not a different role's specific path
            if (item.roles.includes(currentRole) && !item.href.includes('/student') && !item.href.includes('/tutor')) {
                return true;
            }
            return false;
        });
    ...
    const getAdjustedHref = (href)=>{
        // Only adjust if it's a shared base path like /dashboard/sessions, etc.
    ...
    const navLinkClasses = (href)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cn"])("flex items-center justify-start gap-3 rounded-lg px-3 py-2 transition-all", "text-sidebar-muted-foreground hover:text-sidebar-accent-foreground hover:bg-sidebar-accent/10", {
            "bg-sidebar-accent/20 text-sidebar-accent-foreground font-semibold": pathname === getAdjustedHref(href)
        });
    const navLinkLabelClasses = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cn"])("origin-left transition-opacity duration-200 ease-in-out whitespace-nowrap", isCollapsed ? "opacity-0 w-0 h-0 pointer-events-none" : "opacity-100");
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("aside", {
        ...
        children: [
            isDesktop && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cn"])("flex h-16 items-center border-b px-4 shrink-0", "border-sidebar-border", isCollapsed ? "justify-center" : "justify-between"),
                children: [
...
//# sourceMappingURL=src_431c70a0._.js.map