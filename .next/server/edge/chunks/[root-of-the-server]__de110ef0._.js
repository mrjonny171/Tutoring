...
async function middleware(request) {
    ...
    const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$ssr$2f$dist$2f$module$2f$createServerClient$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["createServerClient"])(("TURBOPACK compile-time value", "https://zklfxzlknnubnwzzkuaw.supabase.co"), ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InprbGZ4emxrbm51Ym53enprdWF3Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDQ0ODk3MzQsImV4cCI6MjA2MDA2NTczNH0.jpAk-fd3kRFENDXn6LdMife5_QEA9PvAnw158tnm9iw"), {
        cookies: {
            get (name) {
    ...
    const protectedRoutes = [
        '/dashboard'
    ]; // Add more routes/patterns as needed
